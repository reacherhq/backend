...
5. Use `cargo install rargs` and run the following to apply migrations - `ls migrations/**/*up.sql | rargs psql postgres://postgres:<password>@localhost/postgres -f migrations/{0}`
