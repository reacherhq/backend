...
This repository `reacherhq/backend`, as well as the underlying library `check-if-email-exists`, has a dual license: a commercial one suitable for closed-source commercial projects and an AGPL license that can be used in open-source software.
